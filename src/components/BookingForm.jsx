...
import { 
  ...
  RefreshCw, Check, Flame, MessageSquare
} from 'lucide-react';
...
export default function BookingForm() {
  ...
  return (
    <section id="book-appointment" className="py-24 bg-slate-950 border-t border-slate-800 text-slate-100 relative overflow-hidden">
